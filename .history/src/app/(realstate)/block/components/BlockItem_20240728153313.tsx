...
import { CreateBlock, updateBlock, updateBlockModel } from "../services/block";
...
export default function BlockItem({ block }: BlockItemProps) {
  ...
  const onUpdate = async (
    { block, description }: updateBlockModel,
    actions: FormikHelpers<updateBlockModel>
  ) => {
    const res = await updateBlock({ block, description }, block.id);
  };
